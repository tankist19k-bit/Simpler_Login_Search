ОБЯЗАТЕЛЬНО ПОСЛЕ ПРОВЕРКИ УДАЛИ JSON/CSV!!!!!
----------------------------------------------
AFTER THE CHECK, DELETE THE JSON/CSV FILE!!!!!
----------------------------------------------
Как пользоваться:
Экспортируйте файл с паролями из вашего браузера \ менеджера паролей и переместите в папку скрипта
--------------------------------------------------------------------------------------------
How to use:
